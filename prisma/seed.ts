...
async function main() {
  ...
  const personalInfoMap: Record<number, { gender: string; dateOfBirth: string; nationality?: string; nationalId?: string; address?: string; city?: string; country?: string }> = {
    ...
    5:  { gender: "Female", dateOfBirth: "1992-04-20", nationality: "Indian", address: "55 Tech Park", city: "New York", country: "USA" },
    ...
    15: { gender: "Female", dateOfBirth: "1997-04-16", nationality: "Japanese", address: "18 Harbour St", city: "Sydney", country: "Australia" },
